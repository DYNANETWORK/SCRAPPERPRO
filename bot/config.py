#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Copyright (c) Sura Reddy The Programmer
#
...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "Api Scrapper Bot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "API Scrapper")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/api_scrapper_bot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/api_scrapper_bot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "Join @SuraBotStats")
